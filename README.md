...
旨在打破文字与影像的界限，让每一个脑海中的故事都能瞬间化作震撼的视觉盛宴。我们致力于构建一个"创意无界、生成无限"的 AI 生态平台，让故事创作不再受限于绘画技巧或拍摄成本，实现从"想象"到"视界"的无极飞跃。

## 项目简介

故视无极是一个现代化的AI内容创作平台，旨在打破文字与影像的界限，让每一个脑海中的故事都能瞬间化作震撼的视觉盛宴。我们致力于构建一个"创意无界、生成无限"的 AI 生态平台，让故事创作不再受限于绘画技巧或拍摄成本，实现从"想象"到"视界"的无极飞跃。采用前后端分离架构，后端使用Spring Boot框架，前端使用Vue3框架，提供文章生成、图像创作、内容管理等核心功能。
